...
- [x] **Step 1: boxing3d-sandbag.js 작성**
...
- [x] **Step 1: boxing-3d.html 작성 (최소 버전 — 씬 + 샌드백만)**
...
- [x] **Step 1: boxing3d-effects.js 작성**
...
- [x] **Step 1: boxing-3d.html을 전체 HUD/모달 포함 버전으로 업데이트**
...
- [x] **Step 1: 기존 boxing-detection 테스트가 여전히 통과하는지 확인**
